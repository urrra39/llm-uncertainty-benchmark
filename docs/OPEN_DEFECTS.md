...
| HUMAN-COVERAGE | No human has verified any label (gate human_label_coverage fails at 0.0) | open | data/human_validation_sample.csv human_label coverage >= 0.80, per docs/HUMAN_LABELING.md | validity_gates.all_passed for every future run |
